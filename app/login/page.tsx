    ...
    <div className="min-h-screen bg-[#fbf9f9] dark:bg-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-[#8b5b5d] dark:text-gray-400">Inicia sesión en tu cuenta</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#8b5b5d] dark:text-gray-400">
              ...
              <Link href="/register" className="text-[#e8b4b7] hover:underline">
                Regístrate aquí
              </Link>
            </p>
          </div>
